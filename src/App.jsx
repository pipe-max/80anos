            ...
            <div style={{ background: '#f0f7ff', border: '1px solid #1d6eed44', borderRadius: 10, padding: '14px 16px', marginBottom: 16 }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <a
                  ...
                  style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, background: '#0fb3faff', border: '1px solid #1d6eed44', borderRadius: 8, padding: '9px 12px', fontSize: 13, fontWeight: 700, color: '#1d6eed', textDecoration: 'none' }}
                >
                  🗺️ Google Maps
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, background: '#27ae49ff', border: '1px solid #33ccff44', borderRadius: 8, padding: '9px 12px', fontSize: 13, fontWeight: 700, color: '#00b0cc', textDecoration: 'none' }}
                >
                  🚗 Waze
                </a>
              </div>
